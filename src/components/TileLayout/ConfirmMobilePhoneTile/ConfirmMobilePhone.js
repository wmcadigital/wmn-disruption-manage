          ...
          <fieldset className="wmnds-fe-fieldset">
            <legend className="wmnds-fe-fieldset__legend">
              <p>
                ...
                <strong>{omitCountryCode(subscriberState.user.mobileNumber)}</strong>. You need to
                confirm your mobile phone number before you can receive text message alerts.
              </p>
              <p>
